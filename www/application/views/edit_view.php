  ...
  <tr>
     ...
     <?php
      	foreach($data as $row)
      	{
     		?>
      <tr>
        <td><input class="full_all form-control" type="text" name="id" disabled value="<?php echo $row['id']?>"></td>
        ...
        <td><input class="full_all form-control" type="date" value="<?php echo $row['date']?>"></td>
