...
class Model_User extends Model
{
	...
	public static function UpdateInfo($id, $last_name, $first_name , $date, $login, $password){
		// $connection = mysqli_connect("localhost", "root", "");
		// $select_db = mysqli_select_db($connection,'appusers');
		// mysqli_query($connection, "SET CHARACTER SET 'utf8'");
		//
		// $str = 'yyyy';
		// $result=mysqli_query($connection, "UPDATE userinfo SET last_name='$str', first_name='$first_name', date='$date', login='$login', password='$password' WHERE id='$id';");
		// return $result;
